...
public class VentanaS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtClientes.setBackground(new java.awt.Color(0, 204, 255));
        txtClientes.setColumns(20);
        txtClientes.setForeground(new java.awt.Color(0, 102, 102));
        txtClientes.setRows(5);
        txtClientes.setSelectionColor(new java.awt.Color(51, 255, 255));
